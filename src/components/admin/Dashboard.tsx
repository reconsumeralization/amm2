...
import { Calendar, DollarSign, Users, Clock, TrendingUp, Activity, RefreshCw } from 'lucide-react';
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Monitor your salon's performance and manage operations</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Leverage artificial intelligence to optimize your salon operations
          </CardDescription>
        </CardHeader>
        <CardContent>
