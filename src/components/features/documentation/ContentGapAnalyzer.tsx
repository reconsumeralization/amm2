        ...
        {showFilters && (
          <div className="flex flex-wrap gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            >
              ...
              <option value="BarberShop_owner">BarberShop Owner</option>
              <option value="BarberShop_employee">BarberShop Employee</option>
              <option value="BarberShop_customer">BarberShop Customer</option>
