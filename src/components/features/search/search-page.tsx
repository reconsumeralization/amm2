...
import { TrendingUp, Clock, Users, target as Target, Zap, Search, Filter, Star, Calendar, MapPin, BookOpen, Scissors, Brush, X, ArrowRight, Sparkles, History } from '@/lib/icon-mapping'
