        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/services" className="font-body text-gray-700 hover:text-black transition-colors duration-200">
                Services
              </Link>
              <Link href="/about" className="font-body text-gray-700 hover:text-black transition-colors duration-200">
                About
              </Link>
              <Link href="/team" className="font-body text-gray-700 hover:text-black transition-colors duration-200">
                Team
              </Link>
              <Link href="/contact" className="font-body text-gray-700 hover:text-black transition-colors duration-200">
                Contact
              </Link>
            </div>
            <Button 
