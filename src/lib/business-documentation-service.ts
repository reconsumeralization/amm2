...
export class BusinessDocumentationService {
      ...
      const documentData = {
        ...
        workflow: {
          ...
          history: [{
            ...
            actor: { id: authorId, name: '', role: 'barber_owner' as UserRole },
            timestamp: new Date(),
  ...
  private async processWorkflowAction(
    ...
    if (comment) {
      workflow.comments.push({
        id: this.generateId(),
        author: { id: userId, name: '', role: 'barber_owner' },
        content: comment,
  ...
  private buildSearchQuery(filter: BusinessDocumentationFilter, userRole: UserRole): any {
    ...
    const roleHierarchy = {
      ...
      'barber_owner': ['guest', 'BarberShop_customer', 'BarberShop_employee', 'barber_owner'],
      'developer': ['guest', 'BarberShop_customer', 'BarberShop_employee', 'barber_owner', 'developer'],
      'system_admin': ['guest', 'BarberShop_customer', 'BarberShop_employee', 'barber_owner', 'developer', 'system_admin']
    }
