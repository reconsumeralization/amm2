...
export class BusinessDocumentationService {
  ...
  private buildSearchQuery(filter: BusinessDocumentationFilter, userRole: UserRole): any {
    ...
    const roleHierarchy = {
      ...
      'salon_owner': ['guest', 'BarberShop_customer', 'BarberShop_employee', 'salon_owner'],
      'developer': ['guest', 'BarberShop_customer', 'BarberShop_employee', 'salon_owner', 'developer'],
      'system_admin': ['guest', 'BarberShop_customer', 'BarberShop_employee', 'salon_owner', 'developer', 'system_admin']
    }
