...
export const DocumentationTemplates: any = {
  ...
  access: {
    ...
    create: ({ req: { user } }: AccessContext) => ['system_admin', 'BarberShop_owner', 'developer'].includes(user?.role || ''),
    update: ({ req: { user } }: AccessContext) => ['system_admin', 'BarberShop_owner', 'developer'].includes(user?.role || ''),
    delete: ({ req: { user } }: AccessContext) => ['system_admin', 'BarberShop_owner'].includes(user?.role || ''),
  },
  hooks: {
    beforeChange: [
