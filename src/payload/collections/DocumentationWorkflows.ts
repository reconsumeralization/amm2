...
export const DocumentationWorkflows: CollectionConfig = {
  ...
  timestamps: true,
  access: {
    read: ({ req: { user } }: { req: { user: any } }) => ['system_admin', 'salon_owner', 'developer'].includes(user?.role || ''),
    create: ({ req: { user } }: { req: { user: any } }) => ['system_admin', 'salon_owner'].includes(user?.role || ''),
    update: ({ req: { user } }: { req: { user: any } }) => ['system_admin', 'salon_owner'].includes(user?.role || ''),
