...
export const metadata: Metadata = {
  ...
  description: 'Find answers to common questions about the Modern Men Hair BarberShop management system.',
}
  ...
  const faqCategories = [
    {
      ...
      questions: [
        {
          question: 'What is the Modern Men Hair BarberShop management system?',
          answer: 'It is a comprehensive BarberShop management platform that handles appointments, customer management, staff scheduling, inventory, and business analytics.',
          tags: ['overview', 'features']
        },
        {
          question: 'Who can use this system?',
          answer: 'The system is designed for BarberShop owners, employees (stylists, receptionists), customers, and system administrators. Each role has specific features and permissions.',
          tags: ['roles', 'access']
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Access to features depends on your user role. Contact your BarberShop administrator if you need additional permissions.',
      ...
      questions: [
        {
          ...
          answer: 'Customers can book appointments through the online booking system, mobile app, or by calling the BarberShop. Staff can book appointments through the admin interface.',
          tags: ['booking', 'appointments', 'customers']
        },
        {
          question: 'Can I modify or cancel my appointment?',
          answer: 'Yes, appointments can be modified or cancelled up to 24 hours before the scheduled time through your account or by contacting the BarberShop.',
    ...
    <div className="max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-slate-300 text-lg">
          Find quick answers to common questions about using the BarberShop management system.
        </p>
      </div>
