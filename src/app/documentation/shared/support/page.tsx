...
export const metadata: Metadata = {
  ...
  description: 'Get help and support for the Modern Men Hair BarberShop management system.',
}
  ...
  const supportChannels = [
    {
      ...
      contact: 'support@modernmenhairBarberShop.com',
    ...
    },
    {
      ...
      contact: 'forum.modernmenhairBarberShop.com',
      responseTime: 'Varies',
      availability: '24/7',
